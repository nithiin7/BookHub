package com.nithin.bookhub.activity
...
import com.nithin.bookhub.R
import com.nithin.bookhub.database.BookDatabase
import com.nithin.bookhub.database.BookEntity
import com.nithin.bookhub.util.ConnectionManager
...
class DescriptionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent != null) {
            ...
            finish()
            Toast.makeText(this@DescriptionActivity, "Some error has occurred", Toast.LENGTH_SHORT)
                .show()
        }
